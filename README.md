Sliding Penguins Puzzle Game App
...
Projeyi Açın: Proje klasörünü VS Code ile açın.

Ana Sınıfı Bulun: src/app/SlidingPuzzleApp.java dosyasına gidin.

Çalıştırın: "Run" butonuna tıklayın veya F5 tuşuna basın.
...
Polimorfik Çarpışma Yönetimi (ICollidable):
...
Özyinelemeli (Recursive) Kayma Fiziği:
...
Yapay Zeka (AI) Mantığı :

Oyuncu olmayan penguenler (AI), şu öncelik sırasına göre karar verir:

Yemek olan yöne git.

Güvenli (boş) alana git.

Mecbursa Tehlikeye git.

Son çare olarak Suya git.
